...
if __name__ == "__main__":
    ...
    output_path = os.path.join(output_dir,
                               f"{args.llm}_base_{args.dataset_name}_test_fold_{args.fold}_cold_start_{args.cold_start}.json")
    ...
    result_path = os.path.join(result_dir, f"{args.llm}_{args.prompt_name}_{args.dataset_name}_test_fold_{args.fold}_cold_start_{args.cold_start}.json")
